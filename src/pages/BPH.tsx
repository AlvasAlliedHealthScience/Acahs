    ...
    <div className="px-6 py-10 max-w-5xl mx-auto space-y-10">
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          Bachelor of Public Health (BPH) is a 4-year undergraduate degree comprising 8 semesters,
          designed to prepare candidates with knowledge in various aspects of public health,
          policymaking, education, and disease prevention among the general public.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          Passed in PUC / PDC / HSC (10+2) including VHSE KERALA with a minimum of 40% marks
          in Physics, Chemistry & Biology. <br />
          <strong>Lateral Entry:</strong> Diploma of Para Medical Board (Govt. of Karnataka)
          for lateral entry to 2nd year MLT.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-500 italic text-lg">Loading...</p>
      </section>
