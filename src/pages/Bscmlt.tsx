    ...
    <div className="px-6 py-10 max-w-5xl mx-auto space-y-10">
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
         B.Sc Medical Laboratory Technology is a 4 years under graduate programme including one year internship., 
         This course offers practical & theoretical knowledge related to diagnosis, treatment & prevention of various kinds of ailments & health problems through haematological

         , bacteriological, immunological, chemical, Histopathological & Microscopical evaluation.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
         Passed in PUC/ PDC/ HSC (10+2) including VHSE KERALA with (Medical Laboratory Technology) with a minimum of 40% marks in Physics, Chemistry & Biology          <br />
          <strong>Lateral Entry:</strong> Diploma of Para medical Board (Govt. Of Karnataka) for lateral entry to 2 nd year MLT.
Job Opportunities
        </p>
      </section>
      ...
      {/* Job Opportunities */}
      <section>
        <h2 className="text-2xl font-semibold text-blue-800 mb-3">Highier education</h2>
        <p className="text-gray-500 italic text-lg"> Medical, Preclinical/Paraclinical (Anatomy, Physiology,
Biochemistry, Microbiology, Pathology, pharmacology subjects etc)./</p>
      </section>
