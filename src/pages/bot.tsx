    ...
    <div className="px-6 py-10 max-w-5xl mx-auto space-y-10">
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          B.Sc Operation Theatre and Anaesthesia Technology is a 4-year undergraduate programme including one year internship. 
          This course is designed to provide in-depth knowledge and impart skills for working as an assistant to the consultant Anaesthesiologist 
          as well as to assist in the preparation of the operation theatre before and during emergency surgery.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          Passed in PUC / PDC / HSC (10+2) including VHSE KERALA with (O.T & Anaesthesia Technology) with a minimum of 40% marks 
          in Physics, Chemistry & Biology. Documents must be submitted by Non-Karnataka and foreign national candidates prior to enrollment.
          <br />
      ...
      <section>
        ...
        <ul className="list-disc pl-5 text-gray-700 text-lg">
          <li>Anaesthesia Technologist</li>
          <li>Operation Theatre Technologist</li>
          <li>Surgical Lab Assistant</li>
