    ...
    <div className="px-6 py-10 max-w-5xl mx-auto space-y-10">
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          This course is designed to provide in-depth knowledge and impart skills to prospective students 
          to analyze patient samples, diagnose and report various procedures involved in the process 
          of blood transfusion—from donors to the needy patients—as well as conduct epidemiological surveys.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          Candidates must have passed a B.Sc MLT degree from a recognized university 
          with not less than 50% marks in aggregate.
          <br />
          All foreign nationals must have equivalent educational qualifications approved by the Board of All India Universities, New Delhi.
          <br />
          An eligibility certificate from the REGISTRAR, Rajiv Gandhi University of Health Sciences, Bangalore, 
          must be submitted by non-Karnataka and foreign national candidates prior to enrolment.
        </p>
      </section>
