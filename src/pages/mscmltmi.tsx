    ...
    <div className="px-6 py-10 max-w-5xl mx-auto space-y-10">
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          This course is designed to create expertise in laboratory diagnosis of human diseases 
          caused by bacteria, viruses, fungi & parasites, as well as antimicrobial susceptibility testing, 
          infection control, public health laboratories, quality control, safety management & regulation.
        </p>
      </section>
      ...
      <section>
        ...
        <p className="text-gray-700 text-lg leading-relaxed">
          The candidate must have passed a B.Sc MLT degree from a recognized university 
          with not less than 50% marks in aggregate. 
          <br />
          All foreign nationals should have equivalent educational qualification approved by the Board of All India Universities, New Delhi.
          <br />
